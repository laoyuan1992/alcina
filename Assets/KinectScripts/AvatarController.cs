...
public class AvatarController : MonoBehaviour
{
	...
	[Tooltip("Whether to ignore torso down")]
	public bool torsoOnly = false;
	...
	public void UpdateAvatar(Int64 UserID)
	{
		...
		for (var boneIndex = 0; boneIndex < bones.Length; boneIndex++)
		{
			...
			if (boneIndex2JointMap.ContainsKey(boneIndex))
			{
				...
				if (!torsoOnly || !belowTorsoBoneSet.Contains(joint))
				{
...
//		{24, HumanBodyBones.RightToes},
	...
	protected static readonly HashSet<KinectInterop.JointType> belowTorsoBoneSet = new HashSet<KinectInterop.JointType>
	{
		...
		//KinectInterop.JointType.HandTipLeft,
		//KinectInterop.JointType.ThumbLeft,
		...
		//KinectInterop.JointType.HandTipRight,
		//KinectInterop.JointType.ThumbRight,
