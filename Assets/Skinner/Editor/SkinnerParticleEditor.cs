...
namespace Skinner
{
    ...
    public class SkinnerParticleEditor : Editor
    {
		...
		SerializedProperty _positionJitter;
        ...
        void OnEnable()
        {
			...
			_positionJitter = serializedObject.FindProperty("_positionJitter");
        ...
        public override void OnInspectorGUI()
        {
			...
			EditorGUILayout.PropertyField(_minLife);
			...
			EditorGUILayout.PropertyField(_positionJitter);
