...
namespace Skinner
{
    ...
    public class SkinnerParticle : MonoBehaviour
    {
		...
		{
			get { return _positionJitter; }
			set { _positionJitter = value; }
		}
		[SerializeField]
		float _positionJitter = 0.2f;
        ...
        void InvokeAnimationKernels()
        {
            ...
            else
            {
                ...
                _kernel.material.SetVector("_Life", new Vector3(
                    Time.deltaTime / _maxLife, Time.deltaTime / (_maxLife * _speedToLife),
					Time.deltaTime / _minLife
                ));
				...
				_kernel.material.SetFloat("_PositionJitter", _positionJitter);
        ...
        void UpdateRenderer()
        {
            ...
            block.SetVector("_Scale", new Vector3(_maxScale, _speedToScale, _minScale));
